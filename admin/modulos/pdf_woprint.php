...
$myQuery_b= "SELECT
    ...
    WHERE db_workorders.wo_id='$_POST[printWoID]'";
$mi_consulta->conectar();
...
$tablaDos=$mi_consulta->ejecutar_consulta($myQuery_c);
// Inicializamos Clase
...
$pdf->Cell(20, 8, $_POST['printWoID'],1,1,'C');
...
// Posicion
$pdf->SetY(100);
$pdf->Image($image_file,15,150,20, '', 'PNG', '', 'T', false, 300, '', false, false, 0, false, false, false);
// Company
$pdf->SetX(15);
$pdf->Cell(22, 4, '',$borde,0);
$pdf->SetFont('times', '', 12);
...
$pdf->SetTextColor(255,0,0);
// Detalle/Servicios
while ($filaF = mysqli_fetch_assoc($tablaDos))
{
    $quePieza = $filaF['pieza_nombre'];
    switch($quePieza )
    {
        case 'Crankshaft':
            $pdf->SetY(239);
...
// Generar Archivo
$pdf->Output(DIR_TEMP . "wo_".$_POST['printWoID'].".pdf", 'F',1);
$pdf->Close();
?>