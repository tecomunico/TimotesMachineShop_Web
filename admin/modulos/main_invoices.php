                ...
                <table class="table table-sm table-bordered table-hover-edgar"
                    ...
                    <thead class="blue accent-5 white-text">
                        <tr>
                            ...
                            <th data-field="InvoiceTaxes" data-switchable="false" data-visible="false"></th>
                        </tr>
                    </thead>
                </table>
            </div>
    ...
    <div class="modal-dialog modal-xl modal-notify modal-danger" role="document">
        <div class="modal-content">
            ...
            <form name="FrmAddInvoice" id="FrmAddInvoice" method="post" action="index.php?xpt=003">
                <div class="modal-body">
                    <div class="row mb-1">
                        ...
                        <div class="d-flex align-items-end col-md-6">
                            ...
                            <!-- Sales Tax -->
                            <div class="d-flex custom-control custom-checkbox form-control col-md-3 align-items-start">
                                <input type="checkbox" name="Sales_Taxes" id="Sales_Taxes" class="custom-control-input" value="Y">
                                <label class="custom-control-label text-danger" for="Sales_Taxes">Sales Tax</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <table class="tablesmall" id="tablaFacturas">
                                ...
                                <tr class="altoDeFila">
                                    ...
                                    <td class="tablesmallTD"><input type="text" name='Invoice_Description[]' id='Invoice_Description_1' class="form-control sin-border completeAuto" maxlength="60" for="1"></td>
                    ...
                    <div class="col-md-12">
                        <table class="tablesmall bg-info sinBordes">
                            <tr>
                                ...
                                <th></th>
                                <th width="120px"></th>
                                <th class="conBordes text-right bg-info white-text" width="100px">Sub-Total: </th>
                                <th class="text-right white-text" width="80px" id="SubTotalTotal"></th>
                                <th width="90px"></th>
                            </tr>
                            <tr>
                                <th width="50px"></th>
                                ...
                                <th></th>
                                <th width="120px"></th>
                                <th class="conBordes text-right bg-info white-text" width="100px" id="idTHtaxes"></th>
                                <th class="text-right white-text" width="80px" id="TotalTaxes" value="0.00"></th>
                                <th width="90px"></th>
                            </tr>
                            <tr>
                                <th width="50px"></th>
                                ...
                                <th></th>
                                <th width="120px"></th>
                                <th class="conBordes text-right bg-info white-text" width="100px">Total: </th>
                ...
                <input type="hidden" name="ValorTaxes" id="ValorTaxes">
                <input type="hidden" name="TotalValorSave" id="TotalValorSave">
                <input type="hidden" name="TotalValorTaxes" id="TotalValorTaxes">
...
<div class="modal" id="ModalViewInvoice" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-notify modal-danger" role="document">
        <div class="modal-content">
            ...
            <div class="tableWrapper">    
                <div class="col-md-12">
                    <table class="tablesmall" id="tablaFacturasVer">
                        <thead class="blue accent-5 white-text">
                            <tr class="tablesmallHead tableTHFreeze">
                                <th data-field="idid" class="tablesmallTH" width="50">#</th>
                                <th data-field="Factura_Item" class="tablesmallTH" width="100">Item</th>
                                <th data-field="Factura_Job" class="tablesmallTH">Description</th>
                                <th data-field="Factura_Price" class="tablesmallTH" width="120">Price</th>
                                <th data-field="Factura_Qty" class="tablesmallTH" width="80">Qty</th>
                                <th data-field="Factura_Total" class="tablesmallTH" width="120">Total Cost</th>
                            </tr>
                        </thead>
                    </table>
                </div>
            ...
            <div class="col-md-12">
                <table class="tablesmall bg-info sinBordes">
                    <tr>
                        ...
                        <th width="120px"></th>
                        <th class="conBordes text-right bg-info white-text" width="100px">Sub-Total: </th>
                        <th class="text-right white-text" width="100px" id="SubTotalTotalVer"></th>
                        <th width="1px"></th>
                    </tr>
                    <tr>
                        <th width="50px"></th>
                        ...
                        <th></th>
                        <th width="120px"></th>
                        <th class="conBordes text-right bg-info white-text" width="100px" id="idTHtaxes">Taxes (6.5%): </th>
                        <th class="text-right white-text" width="100px" id="TotalTaxesVer"></th>
                        <th width="1px"></th>
                    </tr>
                    <tr>
                        <th width="50px"></th>
                        ...
                        <th width="120px"></th>
                        <th class="conBordes text-right bg-info white-text" width="100px">Total: </th>
                        <th class="text-right white-text" width="100px" id="TotaldeTotalesVer"></th>
                        <th width="1px"></th>
                    </tr>
                </table>
            </div>
            <div class="modal-footer">
                <button class="btn btn-danger waves-effect btn-md" id="closeVer"><i class="fas fa-window-close mr-2"></i>Close</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="SendModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-md modal-notify modal-indigo" role="document">                          
        <div class="modal-content">
            ...
            <form name="formEmailSend" id="formEmailSend" method="post" action="index.php?xpt=003">
                <div class="modal-body">
                    <div class="d-flex justify-content-left">
                        <!-- Email -->
                        <div class="col-md-12 mb-2">
                            <i class="fas fa-envelope red-text"></i>
                            <label for="Invoice_EmailSend" class="active"><em>eMail</em></label>
                            <input type="email" name="Invoice_EmailSend" id="Invoice_EmailSend" class="form-control">
                        </div>
                    </div>
                    <div class="d-flex justify-content-left">
                        <!-- Email CC -->
                        <div class="col-md-12 mb-2">
                            ...
                            <label for="Invoice_EmailCCSend" class="active"><em>CC</em></label>
                            <input type="email" name="Invoice_EmailCCSend" id="Invoice_EmailCCSend" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <input type="hidden" name="BtnEnvioEmail" id="BtnEnvioEmail" value="Y">
                    <input type="hidden" name="InvEmailID" id="InvEmailID">
                    <input type="hidden" name="InvEmailIDsin" id="InvEmailIDsin">
                </div>
            </form>
        </div>
    </div>
...
<script>
	$(function () 
    {
		...
		$('#Invoice_Add').click(function () 
        {
            $.getJSON("json/json_parametros.php", function(data)
            {
                ...
                items.forEach(function(items) 
                {
                    ...
                    fooTaxes = items.prm_taxes;
                    FechaInvoice(foo,fooTaxes);
                });
            });
        ...
        function FechaInvoice(diasTerm,taxesFoo)
        {
            $variable = diasTerm;
            var fechaParaGrabar=moment().format("YYYY-MM-DD");
            $('#plazoInvoice').val($variable);
            $('#ValorTaxes').val(taxesFoo);
            $('#idTHtaxes').text('Taxes ('+taxesFoo+'%):');
            switch($variable)
            {
                case 'Upon Receipt':
                    var cantidadDias = 0;
        ...
        $("#btnAddinvoice").click(function()
        {
            ...
            var dateVenceGrabar=moment(dateSumada).format("YYYY-MM-DD");
            var cuantasFilaSon = ($('#tablaFacturas').find('tr').length)-1;
            $("#FechaDueSave").val(dateVenceGrabar);
        ...
        $("#Invoice_View").click(function()
        {
            ...
            if(IDcodigo != "")
			{
                ...
                var cuantoTaxes = obj[0].InvoiceTaxes;
                var cuantoSubTotal = parseFloat(currency(cuantoSumo))-parseFloat(currency(cuantoTaxes));
                var SubTotalcuanto = currency(cuantoSubTotal).format();
                var taxesConFormato = currency(cuantoTaxes).format();
                var totalConFormato = currency(cuantoSumo).format();
                ...
                $("#SubTotalTotalVer").text(SubTotalcuanto);
                $("#TotalTaxesVer").text(taxesConFormato);
                $("#TotaldeTotalesVer").text(totalConFormato)
                $('#ModalViewInvoice').modal('show');
				// Ver Factura Detalle
                $.getJSON("json/json_invoicedetail.php?inv="+NumeroDeFactura, function(data)
                {
                    valores = data;
                    var invoice_data ='';
                    var fila =1;
                    ...
                    {
                        item = valores.Factura_Item;
                        job = valores.Factura_Job;
                        price = valores.Factura_Price;
                        qty = valores.Factura_Qty;
                        subtotal = valores.Factura_Total;
                        invoice_data +='<tr class="altoDeFila">';
                        invoice_data +='<td class="tablesmallTD text-center text-danger form-control">'+fila+'</td>';
                        invoice_data +='<td class="tablesmallTD text-center">'+item+'</td>';
                        invoice_data +='<td class="tablesmallTD">'+job+'</td>';
                        invoice_data +='<td class="tablesmallTD text-right">'+currency(price).format()+'</td>';
                        invoice_data +='<td class="tablesmallTD text-center">'+qty+'</td>';
                        invoice_data +='<td class="tablesmallTD text-right">'+currency(subtotal).format()+'</td>';
                        invoice_data +='</tr>';
                        fila ++;
                    });
                    $('#tablaFacturasVer').append(invoice_data);
                })
			}else{
        ...
        {
            $("#tablaFacturasVer").find("tr:gt(0)").remove();
            $('#ModalViewInvoice').modal('hide');
        });
        ...
        function calculateSubTotal() 
        {
          ...
          if($('#Sales_Taxes').prop('checked'))
          {
            quePocentaje = $("#ValorTaxes").val()/100;
          }
          var SubtotSinFormato  = currency(subtotal);
          var TotalSinFormato  = parseFloat(subtotal)+parseFloat(subtotal*quePocentaje);
          var SubtotTotal = currency(subtotal,{separator:',',decimal: '.'}).format();
          var taxesRate  = currency(SubtotSinFormato*quePocentaje).format();
          var totTotal = currency(TotalSinFormato).format();
          var taxesRateSin = currency(taxesRate);
          $('#SubTotalTotal').text(SubtotTotal);
          $('#SubTotalTotal').val(SubtotTotal);
          $("#TotalTaxes").val(taxesRate);
          $("#TotalTaxes").text(taxesRate);
          $("#TotalValorTaxes").val(taxesRateSin);
          $('#TotaldeTotales').text(totTotal);
          $('#TotaldeTotales').val(totTotal);
          $('#TotalValorSave').val(TotalSinFormato.toFixed(2));
        }

        // AutoComplete
        var options = {
            url: "json/json_items.php",
            getValue: "items_job",
            list: {
                match: {
                    enabled: true
        ...
        $(document).on('click', '.completeAuto', function() 
        {
            
            var id_fila = $(this).attr("for");
            $("#Invoice_Description_"+id_fila).easyAutocomplete(options);
            $("#Invoice_Description_"+id_fila).focus();
        });

        // Taxes
        $("#Sales_Taxes").click(function()
        {
            // Verificar
            var CualSubTotal = $('#SubTotalTotal').val();
            var TaxesTaxes = $('#TotalTaxes').val();
            var EstatusTaxes = $('#Sales_Taxes').prop('checked')
            var TotalFinal = $('#TotaldeTotales').val();
            if(EstatusTaxes == false)
            {
                $('#TotalTaxes').val('0.00')
                $('#TotalTaxes').text('0.00')
                var RestaTaxesSin = currency(CualSubTotal).format();
                var RestaTaxesCon = currency(CualSubTotal,{separator:',',decimal: '.'}).format();
                $('#TotaldeTotales').val(RestaTaxesSin);
                $('#TotaldeTotales').text(RestaTaxesCon);
            }else{
                calculateSubTotal();
            }
        })
        ...
        // Tabla Colores
        $('#tabla_invoices').on('click-row.bs.table', function (e, row, $element) 
        {
        ...
        {
            id = $('#tabla_invoices').find('[type="radio"]:checked').map(function(){
				return $(this).closest('tr').find('td:nth-child(2)').text();
			}).get();
            if(id != "")
            {
                var data = JSON.stringify($("#tabla_invoices").bootstrapTable('getSelections'));
                var obj = JSON.parse(data);
                var Email = obj[0].InvoiceClienteCorreo;
                var IDsin = obj[0].InvoiceNumero;
                $('#Invoice_EmailSend').val(Email);
                $('#InvEmailID').val(id);
                $('#InvEmailIDsin').val(IDsin);
                $('#SendModal').modal('show');
            }else{
                alert("Error !! You must be select a Invoice");
            }
        })
        ...
        {
            if($("#Invoice_EmailSend").val()=="")
            {
                alert("Error: the email address is mandatory");
                $("#Invoice_EmailSend").focus();
                return;
            }
